...
![Week 8 Warm Start Neural Network Update](STAT-4830-project-base/docs/figures/warm_start_nn_update_week8.png)
...
![Week 8 Warm Start Neural Network Improvements](STAT-4830-project-base/docs/figures/warm_start_nn_week8.png)
...
Improvement                                 : +0.0748
![Week 8 SRCNN Update](STAT-4830-project-base/docs/figures/SRCNN_update_week8.png)

Here is also an example with a normal image:
![SRCNN Normal Image Reconstruction](STAT-4830-project-base/docs/figures/clock_image_reconstructed.png)
